...
dashboard.section.buttons.val = {
  ...
  dashboard.button("u", "📂  Open University folder", ":silent Telescope file_browser path=D:/OneDrive_MSFT/University<CR>"),
  ...
  dashboard.button("U", "🔍  Search in University folder", ":silent Telescope find_files cwd=D:/OneDrive_MSFT/University<CR>"),
